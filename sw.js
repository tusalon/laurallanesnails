...
const urlsToCache = [
  ...
  '/laurallanesnails/calendar.html',
  ...
  '/laurallanesnails/utils/push-config.js',
  '/laurallanesnails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/laurallanesnails/icons/icon-192x192.png',
    badge: '/laurallanesnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/laurallanesnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/laurallanesnails/admin.html';
  event.waitUntil(
